...
namespace DeLaSur.Backend.Application.Commands.Tarifa.Save
{
    public class SaveTarifaCommandHandler : IRequestHandler<SaveTarifaCommand, ResponseModel>
    {
        ...
        public SaveTarifaCommandHandler(IUnitOfWork unitOfWork, IScrapingService scrapingService)
        {
            this.scrapingService = scrapingService;
            this.unitOfWork = unitOfWork;
            tarifaRepository = new TarifaRepository(unitOfWork.Connection, unitOfWork.Transaction);
        }
